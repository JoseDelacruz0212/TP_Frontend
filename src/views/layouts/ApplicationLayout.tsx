...
const ApplicationLayout = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen lg:flex-row">
            <div className={`bg-primary text-on-primary sticky top-0 lg:min-h-screen lg:pt-5 ${isMenuOpen ? 'min-h-screen' : ''}`}>
            ...
            <main className="bg-background flex-1 py-5 px-4 sm:px-10 h-screen flex flex-col">
