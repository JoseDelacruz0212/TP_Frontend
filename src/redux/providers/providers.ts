...
import {objectivesSlice} from "../slices/objectives";
...
export const withObjectivesProvider = <P extends object>(children: React.ComponentType<P>) =>
    (props: P) => withSliceProvider<P>(objectivesSlice, children)(props);
