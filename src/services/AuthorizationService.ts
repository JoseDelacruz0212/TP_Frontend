...
class AuthorizationService {
    private permissions: {
        ...
        [Roles.ADMIN]: ["*"],
        [Roles.INSTITUTION]: ["COURSES", "COURSES-USERS", "COURSES-ASSESSMENTS", "COURSES-OBJECTIVES", "COURSES-ADD", "COURSES-EDIT", "COURSES-DELETE", "ASSESSMENT-*", "USERS", "USERS-APPROVE", "USERS-REVOKE", "USERS-EDIT", "USERS-DELETE", "USERS-ADD"],
