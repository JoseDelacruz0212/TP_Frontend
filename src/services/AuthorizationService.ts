...
class AuthorizationService {
    private permissions: {
        ...
        [Roles.ADMIN]: ["*"],
        [Roles.INSTITUTION]: ["COURSES", "COURSES-USERS", "COURSES-ASSESSMENTS", "COURSES-OBJECTIVES", "COURSES-ADD", "COURSES-EDIT", "COURSES-DELETE", "ASSESSMENT-*", "USERS", "USERS-APPROVE", "USERS-REVOKE", "USERS-EDIT", "USERS-DELETE", "USERS-ADD", "USERS-ASSIGN-COURSE"],
        [Roles.TEACHER]: ["COURSES", "COURSES-USERS", "COURSES-ASSESSMENTS", "COURSES-OBJECTIVES", "ASSESSMENT", "ASSESSMENT-ADD", "ASSESSMENT-VISUALIZE", "ASSESSMENT-DESIGN", "ASSESSMENT-PUBLISH", "USERS"],
        [Roles.STUDENT]: ["COURSES", "COURSES-ASSESSMENTS", "ASSESSMENT", "ASSESSMENT-START", "USERS"]
    };
